...
Example showing how to use ewdGateway with Cache, on a Linux of OS X system

(For Cache on Windows, see ewdCacheWindows.js)

Assumes you have a Cache database available on the same system that you run this example.

The example will:

- provide a web server that listens on port 8085
- start up 2 Cache child processes
